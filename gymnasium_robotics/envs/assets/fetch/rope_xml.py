...
rope_xml.append(f'<geom name="CGH0" size="{cylinder_diam} {cylinder_height}" pos="0 0 .01" type="cylinder" material="block_mat"></geom>')
...
#    rope_xml.append(f'<geom name="CGH{i}" size="0.001 .01" pos="0 0 .01" type="cylinder"></geom>')
    rope_xml.append(f'<geom name="CGH{i}" size="{cylinder_diam} {cylinder_height}" pos="0 0 .01" type="cylinder" material="block_mat"></geom>')
#    rope_xml.append('<inertial pos="0 0 0" quat="0.707107 0 0.707107 0" mass="0.00136136" diaginertia="2.52375e-06 2.52375e-06 6.38791e-07"/>')
